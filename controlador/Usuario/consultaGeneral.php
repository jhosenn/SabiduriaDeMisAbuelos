          ...
          <tbody>
            ...
            while ($reg=mysqli_fetch_array($registros))
            {
              ...
              echo "
                <td>
                  <div class='btn-group'>
                   <a href='modificarDatosFromUsuario.php?idusuario=" . $reg['idusuario'] . "'> <button class='btn btn-warning'>Modificar</button></a>
                   <a href='eliminar.usuario.php?idusuario=" . $reg['idusuario'] . "'>  <button class='btn btn-danger'>Eliminar</button></a>
                  </div>
                </td>
              ";
              echo "</tr>";
