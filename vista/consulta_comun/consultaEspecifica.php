                  ...
                  <div class="card-header bg-success">
					...
					<?php
								...
								mysqli_close($conexion);
	                                ...
	                                echo'<a class="btn btn-default btn-light bg-success" href="../consulta_comun/fromBuscarComun.php" role="button">Volver al inicio</a>';
