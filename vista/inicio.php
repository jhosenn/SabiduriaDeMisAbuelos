                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" role="presentation" href="../vista/cita/from_cambio_contraseña.php">Cambiar contraseña</a></li>
                                <li><a class="dropdown-item" role="presentation" href="../vista/cerrar_session.php">Cerrar</a></li>
